...
function applyTheme(theme) {
    if (theme === 'dark') {
        ...
        document.documentElement.style.setProperty('--bgImg', 'url(https://github.com/PRASSamin/portfolio/blob/portfolio-live/images/dark-bg.jpg?raw=true)');
        ...
        document.documentElement.style.setProperty('--blog-button-hover', '#ffffff');
        document.documentElement.style.setProperty('--bgImg', 'url(https://github.com/PRASSamin/portfolio/blob/portfolio-live/images/white-bg.jpg?raw=true)');
        document.documentElement.style.setProperty('--gtop', 'rgba(245, 245, 241, 0)');
