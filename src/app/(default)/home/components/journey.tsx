...
const JourneySection = ({ totalProjects }: Props) => {
  ...
  // State for the counters and animation
  ...
  useEffect(() => {
    ...
    // Calculate targets inside useEffect to avoid unnecessary re-renders
    const targetYears = new Date().getFullYear() - 2020;
    ...
    >
      ...
      <div className="flex gap-3 w-full items-center justify-evenly">
        ...
        <div className="flex items-center gap-3">
          <span className="text-5xl lg:text-6xl font-bold">{years}</span>
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex items-center">
            ...
            {/* + Sign Animation */}
            <motion.span
              className="text-5xl lg:text-6xl font-bold absolute left-full"
